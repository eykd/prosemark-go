...
- Go 1.25.6 + cobra v1.10.2, spf13/pflag v1.0.9 (004-agent-native-cli)
- Filesystem (`_binder.md`, `.prosemark.yml`, `{uuid}.md` node files) (004-agent-native-cli)
...
## Recent Changes
- 004-agent-native-cli: Added Go 1.25.6 + cobra v1.10.2, spf13/pflag v1.0.9
